...
for loop = 1:TrainLoops
    ...
    In(2,INPUT2(1,1):INPUT2(1,2)) = InAmp(1);
    In(3,INPUT3(1,1):INPUT3(1,2)) = InAmp2(stim);
    
    noiseArr = NoiseAmp*randn(numEx,tmax + postTime) + WInEx*In;
    ...
    if TRAIN_SWITCH == 0 && TRAIN_RECURRENT_SWITCH == 0 && READW_SWITCH == 1
        %         fig = figure(stim+5);
        %         SP1 = subplot(2,1,1);
        %         imagesc(historyEx);
        %         SP2 = subplot(2,1,2);
