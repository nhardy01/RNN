...
#----------------------------------------------------------------------------
            ...
            # $NVCC was set above.
            CC='$NVCC'
            CFLAGS="-gencode=arch==compute_30,code=\\\"sm_30,compute_30\\\" -I$TMW_ROOT/toolbox/distcomp/gpu/extern/include --compiler-options=-ansi,-D_GNU_SOURCE,-fexceptions,-fPIC,-fno-omit-frame-pointer,-pthread"
            CLIBS="$RPATH $MLIBS -lm -lmwgpu /usr/local/cuda/lib64/libcudart.so.7.0"
...
#
            ...
            # $NVCC was set above.
            CXX='$NVCC'
            CXXFLAGS="-gencode=arch=compute_30,code=\\\"sm_30,compute_30\\\" -I$TMW_ROOT/toolbox/distcomp/gpu/extern/include --compiler-options=-ansi,-D_GNU_SOURCE,-fPIC,-fno-omit-frame-pointer,-pthread"
            CXXLIBS="$RPATH $MLIBS -lm -lmwgpu /usr/local/cuda/lib64/libcudart.so.7.0"
